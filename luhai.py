...
# User Button that leads to U code interface
...
# Librarian Button that leads to L code interface
def open_librarian_interface():
    ...
    # Add Librarian interface code here (similar to User Interface)
    # You can add your librarian functionality here, similar to the U code setup

    # Sample function for Librarian (this could be your L code)
    label = ctk.CTkLabel(librarian_root, text="Welcome to the Librarian Interface", font=("Arial", 24, "bold"))
    label.pack(pady=20)

    # Exit Button for Librarian interface
    def exit_program():
        librarian_root.quit()  # Close the L code window

    exit_button = ctk.CTkButton(librarian_root, text="Exit", command=exit_program, font=("Arial", 14), corner_radius=10)
    exit_button.pack(pady=20)

    librarian_root.mainloop()

# Create "User" button
user_button = ctk.CTkButton(frame, text="User", width=200, height=50, font=("Arial", 16, "bold"), corner_radius=10, fg_color="#4CAF50", hover_color="#45a049", command=open_user_interface)
user_button.grid(row=0, pady=20)

# Create "Librarian" button
librarian_button = ctk.CTkButton(frame, text="Librarian", width=200, height=50, font=("Arial", 16, "bold"), corner_radius=10, fg_color="#2196F3", hover_color="#1976D2", command=open_librarian_interface)
librarian_button.grid(row=1)
