...
def open_user_interface():
    ...
    # Exit Button to return to the Main Window
    def exit_program():
        user_root.withdraw()  # Hide the user interface window
...
def open_librarian_interface():
    ...
    # Exit Button to return to the Main Window
    def exit_program():
        librarian_root.withdraw()  # Hide the librarian interface window
        root.deiconify()  # Show the main window again
...
# Main Menu Buttons
user_button = ctk.CTkButton(frame, text="User", command=open_user_interface, font=("Arial", 16), corner_radius=10)
user_button.pack(pady=10)

librarian_button = ctk.CTkButton(frame, text="Librarian", command=open_librarian_interface, font=("Arial", 16), corner_radius=10)
